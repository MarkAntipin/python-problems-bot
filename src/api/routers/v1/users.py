...
from src.models.users import User, UserInitData
...
@router.get('')
async def get_user(
    user_init_data: str = Query(...),
    users_service: UsersService = Depends(get_users_service)
) -> User:
    user_init_data: UserInitData = validate_and_parce_user_init_data(user_init_data_raw=user_init_data)
